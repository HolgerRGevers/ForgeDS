  ...
  return (
    <div className="flex h-full items-center justify-center p-6">
      <div className="w-full max-w-md rounded-lg border border-gray-700 bg-gray-800 p-8 text-center shadow-lg">
        ...
        <p className="mt-2 text-sm text-blue-400">Coming in Phase 3</p>
        <p className="mt-4 text-sm leading-relaxed text-gray-400">
          Visual schema designer, table browser, and query runner for Zoho
          Creator forms and reports. Inspect field types, relationships, and
